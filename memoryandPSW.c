...
void printregisters(void){
    ...
    for(unsigned short i = 0; i<8;i++) printf("R%d: %04x, A%d: %04x, C%i: %04x\n",i, registers[REG][i].word, i, registers[REG][i+8].word, i, registers[1][i].word);
}
